# c:\my_tennis_club\my_tennis_club\my_tennis_club
...
DEBUG =  True  # False   #  True # False   # True new to handle 404.php page not found error 

ALLOWED_HOSTS = ['*']  # new   new to handle 404.php page not found error
